...
chart <-
ggplot(data_cars, 
       aes(x = cc, y = mpg, color = factor(cyl), shape = factor(trans), size = hp)) +
  # Scatterplot
  geom_point() +  
  ...
  guides(
    size = "none", # Hapus legend size(hp)
...
# Simpan Chart
ggsave("Chart/01_Scatterplot.png", chart, dpi = 300, height = 5, width = 10)
```
