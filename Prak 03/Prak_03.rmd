...
install_load("knitr","ggplot2","viridis","dplyr","DT","showtext","ggrepel",
             "GGally","tibble","scales","tidyverse","fmsb")
...
radarchart(data_radar,
           ...
           pcol = c("red", "blue", "green"), # Warna untuk masing-masing mobil
           plwd = 2,        # Ketebalan garis
           plty = 1,        # Tipe garis
           pfcol = c(rgb(1, 0, 0, 0.25), rgb(0, 0, 1, 0.25), rgb(0, 1, 0, 0.25)))  # Warna area transparan

legend("topright", legend = c("Mazda RX4", "Datsun 710", "Hornet 4 Drive"),
       bty = "n", pch = 20, col = c("red", "blue", "green"),
