...
# Ukuran garis (tebal untuk 3 mobil utama, tipis untuk lainnya)
linewidth_mapping <- c(2.5, 2.5, 2.5, 0.5)  
size_mapping <- setNames(linewidth_mapping, levels(data_cars$highlight))
...
ggparcoord(data_cars, 
  ...
  scale_size_manual(values = size_mapping) +  # Atur ketebalan garis
