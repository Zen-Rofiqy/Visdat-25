...
![](images/Bg_Visdat.png){style="display: block; margin: auto;" width="393"}
...
# **Materi Praktikum** {style="display: block; margin: auto;"}

![](images/clipboard-4160132647.png){style="display: block; margin: auto;" width="500"}
